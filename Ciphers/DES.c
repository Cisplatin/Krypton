...
// requires: block is a valid BinStr and block->length == 64
BinStr initialPermutation(BinStr block) {
	assert(block != NULL && block->length == 64);
	int permutation[64] = {58, 50, 42, 34, 26, 18, 10, 2,
